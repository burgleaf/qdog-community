...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="inline-flex size-9 cursor-pointer items-center justify-center rounded-full border border-border bg-bg-secondary text-muted transition-colors hover:border-accent hover:text-accent"
