...
import { RepositorySubmissionForm } from "@/components/repository-submission-form";
...
export function GuidePageContent({ categories }: GuidePageContentProps) {
  ...
  const fullGuideHref =
    locale === "zh"
      ? "https://github.com/burgleaf/qdog-community/blob/main/docs/zh-CN/submission-guide.md"
      : "https://github.com/burgleaf/qdog-community/blob/main/docs/en/submission-guide.md";
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                href="https://github.com/burgleaf/qdog-community/compare"
                target="_blank"
                rel="noreferrer"
              >
