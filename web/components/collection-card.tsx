...
export function CollectionCard({
  ...
  return (
    <article className="collection-card group flex h-full flex-col overflow-visible rounded-[1.35rem] border border-border bg-bg-elevated hover:border-border-hover">
