...
const copy = {
  ...
  ja: {
    ...
    start: "生命モデルに接続して孵化", retry: "孵化装置に再接続", back: "生命庫に戻る", login: "サイバー生命孵化装置に入るにはログインしてください。", loginCta: "ログイン", missing: "このサイバーエッグが見つからないか、現在のアカウントの所有物ではありません。", complete: "サイバー生命が目覚めました", result: "この結果は永続保存されます。再訪してもモデル枠は追加消費されません。", quota: "本日の孵化枠は終了しました。次の UTC 日にお越しください。", credits: "利用可能クレジット", cost: "今回の孵化は1クレジット", insufficient: "孵化クレジットが不足しています。追加購入機能は近日公開予定です。", failed: "孵化サービスは一時的に混雑しています。クレジットは消費されず、エッグと遺伝子も安全です。後でもう一度お試しください。", exhausted: "孵化サービスでエラーが続きました。エッグとクレジットは保護されています。続く場合はエッグ ID を添えてサポートへご連絡ください。", code: "暗号化生命コード", model: "AI LIFE MODEL · GPT-IMAGE-2 / CF FALLBACK", progress: "孵化同期率",
