...
const copy = {
  ...
  ko: {
    ...
    starterDesc: "계정을 만들면 영구 스타터 에그 하나와 크레딧 10개를 받습니다. 에그 하나를 깨우는 데 1크레딧이 들며, 생성 실패 시 반환됩니다.",
  ...
  ja: {
    ...
    starterDesc: "アカウント作成で永久スターターエッグ1個と10クレジットを獲得。孵化は1回1クレジットで、生成失敗時は返却されます。",
  ...
  es: {
    ...
    starterDesc: "Crea una cuenta para recibir un huevo inicial permanente y 10 créditos. Despertar un huevo cuesta uno; si falla la generación, se devuelve.",
