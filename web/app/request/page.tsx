...
const description =
  "Request a V2 Codex pet for free by entering a character and public image link, then reviewing and publishing the prefilled GitHub Issue. Community contributors may volunteer to make it.";
...
const faq = [
  ...
  },
  {
    ...
    answer:
      "Yes. The character name and a public HTTPS reference image are required. The form prefills a GitHub Issue for you to review and publish.",
  },
  {
      ...
      },
      {
        ...
        step: [
          ...
          },
          {
            ...
            text: "Provide a public HTTPS reference image URL and optionally add the original work and visual preferences. Attach local images directly in the GitHub Issue after continuing.",
          },
          {
            "@type": "HowToStep",
            position: 3,
            name: "Review and publish the Issue",
            text: "Open the prefilled GitHub Issue, sign in if needed, then review and publish the free community request.",
          },
        ],
      },
      {
