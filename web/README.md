...
- **Cyber Eggs and identity**: `qdog-server` is a separate Cloudflare Worker API. Every new account starts with 10 hatch credits and can claim one permanent starter egg; 50 additional eggs are released daily. A successful hatch costs five credits, while failed generations return them.
