...
- **Pet eggs and identity**: `qdog-server` is a separate Cloudflare Worker API. The site has dedicated login, daily code, redemption, and personal-center pages. Public daily codes reveal no traits; a successful redemption creates a trait-backed SVG pet egg in the account backpack.
